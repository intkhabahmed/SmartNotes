...
public interface AppConstants {
    String SORT_CRITERIA = "Sort Criteria";
    String SORT_CRITERIA_ID = "Sort Id";
    int SORT_CRITERIA_ID_DEFAULT = 4;
    String COLUMN_DATE_CREATED_ASC = "dateCreated ASC";
    ...
    String NOTE_ID_FOR_REMINDER = "note_id_for_reminder";
